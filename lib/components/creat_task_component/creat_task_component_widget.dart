...
import 'creat_task_component_model.dart';
export 'creat_task_component_model.dart';

class CreatTaskComponentWidget extends StatefulWidget {
  const CreatTaskComponentWidget({
    super.key,
  ...
  @override
  State<CreatTaskComponentWidget> createState() =>
      _CreatTaskComponentWidgetState();
}

class _CreatTaskComponentWidgetState extends State<CreatTaskComponentWidget> {
  late CreatTaskComponentModel _model;
